...
func (c *authServiceClient) Register(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
...
func (UnimplementedAuthServiceServer) Register(context.Context, *UserRequest) (*AuthResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Register not implemented")
}
func (UnimplementedAuthServiceServer) Login(context.Context, *UserRequest) (*AuthResponse, error) {
